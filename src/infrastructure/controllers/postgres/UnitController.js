...
const UnitService = require('../../../application/services/postgres/UnitService')
const AsociacionModel = require('../../../application/services/postgres/AsociacionService')
...
class UnitController {
  ...
  async create(req, res) {
    ...
    const asociacion = await AsociacionModel.getAsociacionById(asociacionId)
